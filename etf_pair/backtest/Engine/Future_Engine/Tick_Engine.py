...
class Tick_strategy_class(Strategy_Class):
    @func_intro
...
class Tick_Engine(Basic_Engine):
    def define_strategy(self):
        self.strategy = Tick_strategy_class(self)
    ...
    def send_market_orders(self,code,volume,direction,longshort,**args):
        direct = Tick_Engine.judge_sell_buy(direction,longshort)
    ...
    def run_backtesting(self,day,freq:int,typing='normal'):
        ...
        main_code = Tick_Engine.get_main_contract(_file)
